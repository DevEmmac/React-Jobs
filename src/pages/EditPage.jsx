      ...
      <div className="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
        ...
        <form onSubmit={submitForm}>
          ...
          <div className="mb-4">
            ...
            <select id="type" name="type" className="border rounded w-full py-2 px-3" value={type} onChange={(e) => setType(e.target.value)}required>
          ...
          <div className="mb-4">
            ...
            <input type="text" id="title" name="title" className="border rounded w-full py-2 px-3 mb-2" placeholder="eg. Beautiful Apartment In Miami" value={title} onChange={(e) => setTitle(e.target.value)} required/>
          </div>
