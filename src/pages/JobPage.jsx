    ...
    const job = useLoaderData();
     ...
     const onDeleteClick = (jobId) => {
      ...
      if (!confirm) return;
       ...
       toast.success('Job successfully deleEditJobPage');
    ...
    <div>
      ...
      <section>
        <div className="container m-auto py-6 px-6">
          <Link to='/jobs' className="text-indigo-500 hover:text-indogo-600 flex items-center"> < FaArrowLeft className='mr-2' /> Back to Job Listings </Link>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
          ...
          <main>
            <div className="bg-white p-6 rounded-lg shadow-md text-center md:text-left">
              ...
              <div
                className="text-gray-500 mb-4 flex alig n-middle justify-center md:justify-start">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
              ...
              <h3 className="text-indigo-800 text-lg font-bold mb-2">{job.title}</h3>
...
const jobLoader = async ({ params }) => {
   const respond = await fetch(`/api/jobs/${params.id}`);
...
//   const [loading, setLoading] = useState(true);
    ...
    //     fetchJob();
    // }, [])
    // return loading ? <Spinner /> : (<h1>JobPage</h1>);
// }
